...
public class AuthService {
    ...
    public Usuario register(CreateUsuarioRequest req) {
        ...
        // Registro público: el rol lo asigna el servidor. Nunca confiar en req.getRol().
        ...
        log.info("Registrando usuario email={} rol={} emailVerificado={}",
                req.getEmail(), usuario.getRol(), usuario.getEmailVerificado());
